...
always use bun for installing packages and running commands
<!-- END:nextjs-agent-rules -->

## Available Skills

- frontend-design(`.agents\skills\frontend-design`) → Use for UI/UX, layout systems, premium hero sections, design systems
- always read the `.agents\skills\next-best-practices` files before creating the code
